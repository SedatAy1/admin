<template>
  ...
  <div class="report-form">
    ...
    <div class="form-grid">
      ...
      <div class="form-group">
        <label>{{ $t('memberReports.registrationDate') }}</label>
        <input type="date" />
        <input type="date" />
      </div>

      <div class="form-group">
        <label>{{ $t('memberReports.groupBy') }}</label>
        <select>
          <option>{{ $t('memberReports.groupOptions.day') }}</option>
          <option>{{ $t('memberReports.groupOptions.week') }}</option>
          <option>{{ $t('memberReports.groupOptions.month') }}</option>
        </select>
      </div>
    </div>
...
const selectedReport = ref('DealerActivities')
