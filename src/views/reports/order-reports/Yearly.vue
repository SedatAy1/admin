  ...
  <div class="report-form">
    ...
    <div class="form-grid">
      <div class="form-group">
        <label>{{ $t('orderReports.reportType') }}</label>
        <select v-model="selectedReport" @change="handleReportChange">
          <option v-for="report in reportOptions" :key="report.value" :value="report.value">
            {{ $t(`orderReports.reportOptions.${report.value}`) }}
          </option>
        </select>
      </div>

      <div class="form-group">
        <label>{{ $t('orderReports.orderStatus') }}</label>
        <select multiple>
      ...
      <div class="form-group">
        <label>{{ $t('orderReports.platform') }}</label>
        <select>
      ...
      <div class="form-group">
        <label>{{ $t('orderReports.store') }}</label>
        <select>
          <option>{{ $t('common.noneSelected') }}</option>
        </select>
      </div>
      ...
      <div class="form-group">
        <label>{{ $t('orderReports.terminal') }}</label>
        <select>
      ...
      <div class="form-group">
        <label>{{ $t('orderReports.orderDate') }}</label>
        <input type="date" />
        <input type="date" />
      </div>

      <div class="form-group">
        <label>{{ $t('orderReports.orderTime') }}</label>
        <input type="time" value="00:00" />
        <input type="time" value="23:59" />
      </div>

      <div class="form-group">
        <label>{{ $t('orderReports.shippingDate') }}</label>
        <input type="date" />
        <input type="date" />
      </div>

      <div class="form-group">
        <label>{{ $t('orderReports.invoiceDate') }}</label>
        <input type="date" />
        <input type="date" />
      </div>

      <div class="form-group">
        <label>{{ $t('orderReports.einvoiceDate') }}</label>
        <input type="date" />
        <input type="date" />
      </div>

      <div class="form-group">
        <label>{{ $t('orderReports.country') }}</label>
        <select>
          <option>{{ $t('common.noneSelected') }}</option>
        </select>
      </div>
      ...
      <div class="form-group">
        <label>{{ $t('orderReports.membershipNo') }}</label>
        <input type="text" />
      </div>

      <div class="form-group">
        <label>{{ $t('orderReports.totalAmount') }}</label>
        <input type="number" value="0.00" />
      </div>

      <div class="form-group">
        <label>{{ $t('orderReports.paymentMethod') }}</label>
        <select>
          <option>{{ $t('common.notSelected') }}</option>
        </select>
      </div>
      ...
      <div class="form-group">
        <label>{{ $t('orderReports.giftCode') }}</label>
        <input type="text" />
      </div>

      <div class="form-group">
        <label>{{ $t('orderReports.giftRef') }}</label>
        <input type="text" />
      </div>

      <div class="form-group">
        <label>{{ $t('orderReports.promotion') }}</label>
        <select>
          <option>{{ $t('common.notSelected') }}</option>
        </select>
      </div>
      ...
      <div class="form-group">
        <label>{{ $t('orderReports.shippingCompany') }}</label>
        <select>
          <option>{{ $t('common.notSelected') }}</option>
        </select>
      </div>
      ...
      <div class="form-group">
        <label>{{ $t('orderReports.advancedSearch') }}</label>
        <select>
          <option>{{ $t('common.noneSelected') }}</option>
        </select>
      </div>
...
const selectedReport = ref('Yearly')
const reportOptions = [
  { value: 'Daily' },
  { value: 'Weekly' },
  { value: 'Monthly' },
