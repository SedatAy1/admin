<template>
  ...
  <div class="report-form">
    ...
    <div class="form-grid">
      ...
      <div class="form-group">
        <label>{{ $t('reports.salesTerminal') }}</label>
        <select>
      ...
      <div class="form-group">
        <label>{{ $t('reports.giftVoucherCode') }}</label>
        <input type="text" />
      </div>

      <div class="form-group">
        <label>{{ $t('reports.giftVoucherReference') }}</label>
        <input type="text" />
      </div>
...
const selectedReport = ref('Platform')
const reportOptions = [
  ...
  { value: 'BrandSales', label: $t('reports.brandSales') },
  { value: 'Payment', label: $t('reports.payment') },
  { value: 'FastDelivery', label: $t('reports.fastDelivery') },
  { value: 'Platform', label: $t('reports.platformReport') },
  { value: 'Store', label: $t('reports.storeReport') },
  { value: 'ProductSales', label: $t('reports.productSales') },
  { value: 'VariantSales', label: $t('reports.variantSales') },
  { value: 'CategorySales', label: $t('reports.categorySales') },
  { value: 'Source', label: $t('reports.source') },
  { value: 'City', label: $t('reports.city') },
  { value: 'Country', label: $t('reports.country') },
  { value: 'Accounting', label: $t('reports.accounting') },
  { value: 'List', label: $t('reports.list') }
]
