  ...
  <div>
    ...
    <div class="report-form">
      ...
      <div class="form-grid">
        ...
        <div class="form-group"><label>{{ $t('productReports.productSource') }}</label><select><option>Kaynak Seçilmedi</option></select></div>
        <div class="form-group"><label>{{ $t('productReports.category') }}</label><select><option>Kategori Seçilmedi</option></select></div>
        <div class="form-group"><label>{{ $t('productReports.brand') }}</label><select><option>Marka Seçilmedi</option></select></div>
        <div class="form-group"><label>{{ $t('productReports.tags') }}</label><select><option>Seçilmedi</option></select></div>
        ...
        <div class="form-group"><label>{{ $t('productReports.advancedFilter') }}</label><select><option>Seçilmedi</option></select></div>
      </div>
...
const selectedReport = ref('VariantStock')
