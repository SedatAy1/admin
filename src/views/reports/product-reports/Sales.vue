    ...
    <div class="report-form">
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <select><option>{{ $t('common.notSelectedSource') }}</option></select>
        </div>

        <div class="form-group">
          <label>{{ $t('productReports.category') }}</label>
          <select><option>{{ $t('common.notSelectedCategory') }}</option></select>
        </div>

        <div class="form-group">
          <label>{{ $t('productReports.brand') }}</label>
          <select><option>{{ $t('common.notSelectedBrand') }}</option></select>
        </div>

        <div class="form-group">
          <label>{{ $t('productReports.tags') }}</label>
          <select><option>{{ $t('common.notSelected') }}</option></select>
        </div>
