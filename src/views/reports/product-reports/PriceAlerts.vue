    ...
    <div class="report-form">
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <select><option>{{ $t('productReports.source') }} {{ $t('ui.notSelected') }}</option></select>
        </div>

        <div class="form-group">
          <label>{{ $t('productReports.category') }}</label>
          <select><option>{{ $t('productReports.category') }} {{ $t('ui.notSelected') }}</option></select>
        </div>

        <div class="form-group">
          <label>{{ $t('productReports.brand') }}</label>
          <select><option>{{ $t('productReports.brand') }} {{ $t('ui.notSelected') }}</option></select>
        </div>

        <div class="form-group">
          <label>{{ $t('productReports.tags') }}</label>
          <select><option>{{ $t('ui.notSelected') }}</option></select>
        </div>

        <div class="form-group">
          <label>{{ $t('productReports.productNo') }}</label>
          <input type="text" />
        </div>
        ...
        <div class="form-group">
          <label>{{ $t('productReports.advanced') }}</label>
          <select><option>{{ $t('ui.notSelected') }}</option></select>
        </div>
      </div>
...
const selectedReport = ref('PriceAlerts')
