<template>
  <MarketLayout>
    <div class="accounting-container">
      <h2 class="section-title">Aktif Entegrasyonlar</h2>
      <p class="section-subtitle">Aşağıdaki entegrasyonlar şu anda aktif durumdadır.</p>
      ...
      <div class="integration-list">
        <div v-for="integration in activeIntegrations" :key="integration.id" class="integration-card">
          ...
          <button class="button-secondary">Muhasebe</button>
          <button class="button-primary" @click="openSettings(integration)">Ayarlar</button>
        </div>
      </div>

      <h2 class="section-title">Pasif Entegrasyonlar</h2>
      <p class="section-subtitle">Aşağıdaki entegrasyonlar henüz etkinleştirilmemiştir.</p>
      ...
      <div class="integration-list">
        <div v-for="integration in inactiveIntegrations" :key="integration.id" class="integration-card">
          ...
          <button class="button-secondary">Muhasebe</button>
          <button class="button-success" @click="activateIntegration(integration)">Etkinleştir</button>
        </div>
      </div>
    </div>
    ...
    <div v-if="modalOpen" class="modal-overlay">
      <div class="modal-content">
        <h2>{{ selectedIntegration.name }} Ayarları</h2>
...
export default {
  ...
  data() {
    return {
      activeIntegrations: [
        { id: 1, name: 'E-Fatura', logo: 'efatura.png', description: 'E-Fatura entegrasyonu' },
        { id: 2, name: 'Netsis (Logo) Muhasebe', logo: 'netsis.png', description: 'Muhasebe sistemleri ile entegre' }
      ],
      inactiveIntegrations: [
        { id: 3, name: 'Muhasebe B2B', logo: 'b2b.png', description: 'Henüz etkinleştirilmemiş' },
        { id: 4, name: 'Nebim Muhasebe', logo: 'nebim.png', description: 'Henüz etkinleştirilmemiş' }
      ],
      modalOpen: false,
      selectedIntegration: {},
      settings: {},
