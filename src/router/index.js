...
const routes = [
        ...
        children: [
            {
                ...
                name: 'MarketplaceMatching',
                component: MarketplaceMatching
            },
            {
                path: 'reviews',
                name: 'ProductReviews',
            ...
            {
                path: 'bulk-actions',
                name: 'BulkProductActions',
                component: BulkProductActions
            },
            {
                path: 'bulk-seo',
                name: 'BulkSEOModifications',
                component: BulkSEOModifications
            }
        ]
    },
    // **Sipariş Sayfaları**
    ...
    // AYARLAR
    {
        ...
        children: [
            ...
            { path: "orders", name: "OrdersSettings", component: Orders },
            { path: "products", name: "ProductsSettings", component: Products },
